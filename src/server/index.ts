...
const productSchema = z.object({
  ...
  regularPriceLabel: z.string().trim().max(80).optional().nullable(),
  salePriceLabel: z.string().trim().max(80).optional().nullable(),
  ...
  saleBadge: z.string().trim().max(80).optional().nullable(),
...
function normalizeProductInput(input: z.infer<typeof productUpdateSchema>) {
  return {
    ...input,
    regularPriceLabel: input.regularPriceLabel || null,
    salePriceLabel: input.salePriceLabel || null,
    stripePaymentLink: input.stripePaymentLink || null,
    imageUrl: input.imageUrl || null,
    badge: input.badge || null,
    saleBadge: input.saleBadge || null,
